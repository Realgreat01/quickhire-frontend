<template>
  <div
    class="scroll bg-brand-dark relative mb-10 h-[460px] w-full overflow-scroll md:w-4/5"
  >
    <div class="">
      <div
      ...
      >
        ...
        >
          <div class="m-2 mx-4 w-full">
            ...
            <p class="w-[40%] truncate text-dark-400 duration-500">
...
definePageMeta({
  ...
  name: QH_ROUTES.COMPANY.NOTIFICATIONS,
});

useHead({
  title: 'QuickHire - Company Notifications',
});
</script>
