<template>
  <div
    class="scroll bg-brand-dark relatives sticky top-0 mx-auto h-[460px] w-full overflow-scroll"
  >
    <h1
      class="qh-text-2 sticky top-0 z-[1] flex items-center gap-x-2 bg-white p-4 font-bold text-brand"
    >
    ...
    <div class="">
      ...
      <div
        class="qh-text-4 relative flex w-fit flex-col font-medium"
...
definePageMeta({
  ...
  name: QH_ROUTES.COMPANY.MESSAGES,
});
